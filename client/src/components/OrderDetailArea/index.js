                            ...
                            <td>
                                <table align='center' border={0} cellPadding={0} cellSpacing={0}>
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 className={styles.title}>{order.order.deleted_by === 1 ? "XIN LỖI" : order.order.deleted_by === 0 ? "RẤT TIẾC" : "CẢM ƠN"}</h2>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                ...
                                {((order.order.status === 0 || order.order.status === 1) && order.order.deleted_by == null) &&
